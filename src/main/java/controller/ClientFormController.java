...
//              #0693e3 #37d67a #40bf75
                textFlow.setStyle("-fx-background-color: #1a1a1a; -fx-font-weight: bold; -fx-color: white; -fx-background-radius: 20px");
...
//        TextFlow textFlow = new TextFlow(imageView);
    ...
    public static void receiveMessage(String msg, VBox vBox) throws IOException {
        if (msg.matches(".*\\.(png|jpe?g|gif)$")){
            ...
            TextFlow textFlow = new TextFlow(text);
            textFlow.setStyle("-fx-background-color: #ffffff ; -fx-font-weight: bold; -fx-background-radius: 20px");
            textFlow.setPadding(new Insets(5,10,5,10));
